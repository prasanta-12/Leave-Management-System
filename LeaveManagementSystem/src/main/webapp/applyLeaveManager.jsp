...
<body class="hold-transition sidebar-mini">
   <!-- invalid massage -->
 <%
            String dayExcidedMan = (String) session.getAttribute("dayExcidedMan");
            if (dayExcidedMan != null) {
        %>
            <script>
                alert("<%= dayExcidedMan %>");
            </script>
          ...
          <div class="col-md-12 ">
            <div class="container-md">
                <h3 class="text-center"><strong>Apply Leave</strong></h3>
                 <form action="apply_leave" class="row g-3 m-5" name="applyleavForm"  id="form" onsubmit="return validation()">
                  <div class="col-md-6">
                    <label for="inputEmpName" class="form-label">Name</label>
                    <input type="text" class="form-control" id="inputEmpName" name="empName" value="${manager.fullname}" readonly="readonly">
                  </div>
                  <div class="col-md-6">
                    <label for="inputEmail" class="form-label">Email</label>
                    <input type="email" class="form-control" id="inputEmail" name="empEmail" value="${manager.email}" readonly="readonly" >
                    <span id="emailerror" class="text-danger font-weight-bold"></span>
                  </div>
                  <div class="col-md-6">
                    <label for="inputEmpId" class="form-label">ID</label>
                    <input type="text" class="form-control" id="inputEmpId" name="empId" value="${manager.id}" readonly="readonly">
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="hidden" class="form-control" id="inputEmpRole" name="role" value="${manager.role}" readonly="readonly">
                  </div>
                  <div class="col-md-6">
                    <!-- <label for="inputReportingPerson" class="form-label">Reporting Manager</label> -->
                    <input type="hidden" class="form-control" id="inputReportingPerson" name="reportingPerson" value="${manager.reportingPerson}" readonly="readonly">
                  </div>
                  <div class="col-md-6">
      ...
      <!--   <div class="col-md-4">
          ...
          <ul class="list-group list-group-flush">
            <table>
              <tbody>
                <tr>
                  <th class="list-group-item" scope="row"> Currently applied </th>
                  <th class="pl-4" > <input id="currApply" type="text" name="daycount" readonly="readonly"></th>
                </tr>
              </tbody>
            </table>
          </ul>
