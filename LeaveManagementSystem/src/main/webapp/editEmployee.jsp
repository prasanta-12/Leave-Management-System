        ...
        <section class="container my-2 w-50 p-2 text-dark shadow bg-white " id="form-data">
            ...
            <form class="row g-3 p-3" action="update_emp" name="addEmpForm"  id="form" method="post" onsubmit="return validation()">
                ...
                <div class="col-md-6">
                  ...
                  <input type="email" value="${employee.email}" class="form-control" id="email" name="email" required>
                  <span id="emailerror" class="text-danger font-weight-bold"></span>
                </div>
    
                <div class="col-md-6">
                  <label for="contact" class="form-label">Contact</label>
                  <input type="number" value="${employee.contact}" class="form-control" id="contact" name="contact" required>
