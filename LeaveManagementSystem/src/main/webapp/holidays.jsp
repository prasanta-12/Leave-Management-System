    ...
    <div class="container" id="hDayTable">
      <table class="table table-dark table-striped caption-top table-hover" >
          ...
          <tr class="table-active">
              ...
              <!-- <td><a href="#" class="acn_item" ><i class="fa fa-solid fa-pen" style='color: #9d8189;'></i></a>&nbsp;&nbsp;
                  <a href="#" class="acn_item"><i class="fa fa-solid fa-trash" style='color: #9d8189;'></i></a>
              </td> -->
            </tr>
          </c:forEach>
...
<!-- Holyday Table end -->
  ...
  <div class="modal fade" id="basicModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Add a Holiday</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="add_holiday"  name="holiDForm" id="holiDForm" onsubmit="return isValidForm()" >
        <div class="modal-body ">
            <div class="container-fluid">

                <div class="row p-3">
                    <div class="col-md-5" id="hDayName">
                        <label  class="form-label">Holiday Name</label>
                        <input type="text" class="form-control" name="hDayName" placeholder="ex: New Year" required>
                        <input type="hidden" value="${admin.id}" name="adminId">
                        <div class="invalidForm">

                        </div>
                      </div>
                      <div class="col-md-5" id="startHDate">
                  ...
                  <div class="row p-3">
                    <div class="col-md-10" id="hDayDesc">
                        ...
                        <input type="text" class="form-control" name="hDayDesc" placeholder="ex: New Year's Day" required>
                        <div class="invalidForm">
                        </div>
                      </div>
                  </div>
