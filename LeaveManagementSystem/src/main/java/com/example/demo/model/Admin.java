	  ...
	  private int id;	
		...
		public String toString() {
			return "Admin [id=" + id + ", fullname=" + fullname + ", email=" + email + ", username=" + username
					+ ", password=" + password + ", contact=" + contact + ", designation=" + designation + ", role="
					+ role + ", reportingPerson=" + reportingPerson + ", status=" + status + ", dob=" + dob + ", doj="
					+ doj + ", address=" + address + ", sickLeave=" + sickLeave + ", casualLeave=" + casualLeave
